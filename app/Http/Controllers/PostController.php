...
class PostController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        return redirect()->back()->with('success', 'Post Berhasil Dihapus/Dipindahan Ke Trash Post');
    }
    ...
    public function restore($id){
        ...
        return redirect()->back()->with('success', 'Post Berhasil Dikembalikan Ke List Post');
    }
